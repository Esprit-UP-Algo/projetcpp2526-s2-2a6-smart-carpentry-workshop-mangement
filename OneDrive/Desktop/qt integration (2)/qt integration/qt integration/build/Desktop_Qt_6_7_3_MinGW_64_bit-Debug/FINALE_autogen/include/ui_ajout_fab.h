/********************************************************************************
** Form generated from reading UI file 'ajout_fab.ui'
**
...
#ifndef UI_AJOUT_FAB_H
#define UI_AJOUT_FAB_H
...
class Ui_Dialog_Ajout_Fabrication
{
public:
    ...
    void setupUi(QDialog *Dialog_Ajout_Fabrication)
    {
        if (Dialog_Ajout_Fabrication->objectName().isEmpty())
            Dialog_Ajout_Fabrication->setObjectName("Dialog_Ajout_Fabrication");
        Dialog_Ajout_Fabrication->resize(420, 320);
        Dialog_Ajout_Fabrication->setStyleSheet(QString::fromUtf8("QDialog { background-color: #f0e6d3; }\n"
...
"QFrame#frame_contenu { background-color: #f5ede0; border: 2px solid #8b5e3c; border-radius: 5px; }"));
        layout_principal = new QVBoxLayout(Dialog_Ajout_Fabrication);
        layout_principal->setSpacing(0);
        layout_principal->setObjectName("layout_principal");
        layout_principal->setContentsMargins(12, 12, 12, 12);
        frame_titre = new QFrame(Dialog_Ajout_Fabrication);
        ...
        frame_contenu = new QFrame(Dialog_Ajout_Fabrication);
        ...
        btn_ajouter = new QPushButton(frame_contenu);
        btn_ajouter->setObjectName("btn_ajouter");
        btn_ajouter->setMinimumSize(QSize(110, 35));
        ...
        retranslateUi(Dialog_Ajout_Fabrication);
        QObject::connect(btn_annuler, &QPushButton::clicked, Dialog_Ajout_Fabrication, qOverload<>(&QDialog::reject));

        QMetaObject::connectSlotsByName(Dialog_Ajout_Fabrication);
    } // setupUi

    void retranslateUi(QDialog *Dialog_Ajout_Fabrication)
    {
        Dialog_Ajout_Fabrication->setWindowTitle(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Ajouter Fabrication", nullptr));
        lbl_titre->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Ajouter une Fabrication", nullptr));
        lbl_id->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "ID Fabrication :", nullptr));
        input_id_fabrication->setPlaceholderText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Ex : FAB-001", nullptr));
        lbl_modele->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Mod\303\250le :", nullptr));
        input_modele->setPlaceholderText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Nom du mod\303\250le", nullptr));
        lbl_date_debut->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Date De D\303\251but :", nullptr));
        input_date_debut->setDisplayFormat(QCoreApplication::translate("Dialog_Ajout_Fabrication", "dd/MM/yyyy", nullptr));
        btn_ajouter->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Ajouter", nullptr));
        btn_annuler->setText(QCoreApplication::translate("Dialog_Ajout_Fabrication", "Annuler", nullptr));
    } // retranslateUi

};

namespace Ui {
    class Dialog_Ajout_Fabrication: public Ui_Dialog_Ajout_Fabrication {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_AJOUT_FAB_H
