...
"}"));
        ...
        le_email = new QLineEdit(Login);
        le_email->setObjectName("le_email");
        le_email->setGeometry(QRect(200, 320, 491, 41));
        label_3 = new QLabel(Login);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(200, 380, 171, 31));
        le_password = new QLineEdit(Login);
        le_password->setObjectName("le_password");
        le_password->setGeometry(QRect(200, 420, 491, 41));
        btn_login = new QPushButton(Login);
        btn_login->setObjectName("btn_login");
        btn_login->setGeometry(QRect(370, 480, 140, 51));
        btn_login->setStyleSheet(QString::fromUtf8("font: 11pt \"Segoe UI\";\n"
